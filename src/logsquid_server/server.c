...
struct default_squid{
    char    timestamp[16], elapsed[16], ipaddress[16], codestatus[51], bytes[16], method[51],
            url[2049], hierarchy[51], username[51], mime[51];
};

struct default_logSquid{
    char    timestamp[16], ipaddress[16], macaddress[18], username[51], serverfqn[101], url[2049],
            ipdest[51], mime[51], bytes[16], codestatus[51];
};
